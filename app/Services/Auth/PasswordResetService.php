...
class PasswordResetService
{
     ...
     * @return string
     */
    protected function getPasswordResetURL($token, $email)
    {
    ...
    public function getEmail($token, $email, $username)
    {
        ...
        $url = $this->getPasswordResetURL($token, $email);
...
//            
//            $expiryDate = $this->getExpiryDate();
//            $url = $this->getPasswordResetURL($email);
//            
//            $passwordResetEmail = new PasswordReset($username);
//            
//            $passwordResetEmail->setTokens([
...
//            ]);
//            
//            Mail::to($user)->send($passwordResetEmail);
//            
//            return true;
//        }
//        else {
